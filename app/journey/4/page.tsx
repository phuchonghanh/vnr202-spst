...
export default function Journey4() {
        ...
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="relative">
                    <div className="w-80 h-80 bg-white bg-opacity-90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-2xl border-4 border-gray-800">
                ...
                >
                    <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-lg p-4 shadow-lg border border-red-200 hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer">
                        <div className="flex items-center mb-2">
                            <div className="w-8 h-8 bg-gray-800 text-white rounded-full flex items-center justify-center font-bold text-sm mr-3">
                                {trait.id}
                            </div>
                        ...
                        {hoveredCard === trait.id && (
                            <div className="mt-3 p-3 bg-gray-50 rounded border-l-4 border-gray-800 animate-fade-in">
            ...
            <div className="absolute bottom-4 left-4 z-20">
                <a
                    href="/"
                    className="bg-gray-800 text-white px-6 py-3 rounded-lg hover:bg-gray-900 transition-colors shadow-lg bg-opacity-90 backdrop-blur-sm"
                >
                    ← Về trang chủ
                </a>
            </div>
